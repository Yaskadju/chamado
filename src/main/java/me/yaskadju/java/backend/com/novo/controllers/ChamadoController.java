package me.yaskadju.java.backend.com.novo.controllers;
...
import me.yaskadju.java.backend.com.novo.business.ChamadoBus;
...
public class ChamadoController {
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Path("{id}/")
	public Chamado getChamado(@PathParam("id") long id) throws ClassNotFoundException {
